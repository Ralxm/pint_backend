...
app.use('/aprovacao', middleware.checkToken, Aprovacao);
app.use('/auditlog', middleware.checkToken, Auditlog);
app.use('/cargo_permissao', middleware.checkToken, Cargo_permissao);
app.use('/cargo', middleware.checkToken, Cargo);
app.use('/categoria', middleware.checkToken, Categoria);
app.use('/cidade', middleware.checkToken, Cidade);
app.use('/colaborador_cargo', middleware.checkToken, Colaborador_cargo);
app.use('/colaborador', Colaborador);
app.use('/comentario', middleware.checkToken, Comentario);
app.use('/edicao_comentario', middleware.checkToken, Edicao_comentario);
app.use('/edicao_publicacao', middleware.checkToken, Edicao_publicacao);
app.use('/espaco', middleware.checkToken, Espaco);
app.use('/evento', middleware.checkToken, Evento);
app.use('/opcoes_escolha', middleware.checkToken, Opcoes_escolha);
app.use('/permissoes', middleware.checkToken, Permissoes);
app.use('/post', middleware.checkToken, Post);
app.use('/questionario', middleware.checkToken, Questionario);
app.use('/subcategoria', middleware.checkToken, Subcategoria);
app.use('/voto', middleware.checkToken, Voto);
app.use('/rawquery', middleware.checkToken, RawQuery);
app.use('/mix', middleware.checkToken, Mix);
app.use('/aviso', middleware.checkToken, Aviso);
app.use('/mudarpassword', middleware.checkToken, MudarPassword);
